...
#    url("^$", direct_to_template, {"template": "index.html"}, name="home"),
    ...
    # OWN URLPATTERNS AND MEZZANINE'S URLS
    # ------------------------------------
    ...
    # ``mezzanine.urls``.
    url("^bases-de-datos/$", "hpp.dbsdwnld.views.table", name="FASTA DataBases"),
    # url("^test/$", "hpp.dbsdwnld.views.dbsdwnld_view", name="test"),
