    ...
    extends Service
{
    ...
    private final static Logger logger = Logger.getLogger(org.biomart.api.soap.BioMartSoapService.class.getName());

    static {
        URL url = null;
        try {
            URL baseUrl;
            baseUrl = org.biomart.api.soap.BioMartSoapService.class.getResource(".");
            url = new URL(baseUrl, "http://central.biomart.org/martsoap?wsdl");
        } catch (MalformedURLException e) {
            logger.warning("Failed to create URL for the wsdl Location: 'http://central.biomart.org/martsoap?wsdl', retrying as a local file");
    ...
    public BioMartSoapService() {
        super(BIOMARTSOAPSERVICE_WSDL_LOCATION, new QName("http://soap.api.biomart.org/", "BioMartSoapService"));
    }
